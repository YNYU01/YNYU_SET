      ...
      return new Promise((resolve, reject) => {
        if(quality == 10){
          ...
          img.onload = function(){
            ...
            //console.log(data.buffer,UPNG.encode([data.buffer], img.width, img.height, 0),newimg)
            
            let url2 = URL.createObjectURL(newimg);
            let img2 = new Image()
            img2.src = url2;
            ...
            img2.onload = function(){
              ...
              let imageData2 = ctx2.getImageData(0,0,img2.width,img2.height);
              ...
              let diff = ditherColor(data2, img.width, img.height).pixels
