...
function getUserColor(node){
  ...
  if(node.getAttribute('data-table-theme-color') !== null){
    let intime = getElementMix('setheme-intime');
    if(intime.checked){
      let theme = getElementMix('data-table-theme').getAttribute('data-select-value');
      let option = getElementMix(`data-option-value="${theme}"`);
      theme = option ? option.getAttribute('data-en-text') : theme;
      toolMessage([[[theme,color.HSL],'theme'],'reTable'],PLUGINAPP);
    }
  }
  //console.log(color)
};
...
function getUserSelect(node){
  ...
  if(node.getAttribute('data-table-theme') !== null){
    let intime = getElementMix('setheme-intime');
    if(intime.checked){
      let theme = userSelect;
      let option = getElementMix(`data-option-value="${theme}"`);
      theme = option ? option.getAttribute('data-en-text') : theme;
      let color = getElementMix('data-table-theme-color').getAttribute('data-color-hsl');
      toolMessage([[[theme,color],'theme'],'reTable'],PLUGINAPP);
