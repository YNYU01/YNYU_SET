...
class inputfontsize extends HTMLElement {
  constructor() {
    ...
    ${icon(20)}
      ...
      <path ${pathS('auto')} d="M19 11.5H17.667C17.6668 10.7637 17.0693 10.167 16.333 10.167H16V15C16.0001 15.5523 16.4478 16 17 16V18H12.5V16C13.0523 16 13.5 15.5523 13.5 15V10.167H13.167C12.4308 10.167 11.8332 10.7637 11.833 11.5H10.5V7.5H19V11.5Z"></path>
    </svg>
      `;
  }
};
...
class inputtabletitle extends HTMLElement {
  constructor() {
    ...
    ${icon(20)}
      ...
      <rect ${pathS(null,'auto')} ${rectS(5.9,5.56,1.42,7.14)} x="1.40967" y="7.13843" width="5.63721" height="5.5603"></rect>
      <path ${pathS(null,'auto')} d="M1.40967 12.6987H7.34688V18.2185H3.40967C2.3051 18.2185 1.40967 17.3231 1.40967 16.2185V12.6987Z"></path>
      <path ${pathS('auto','auto')} d="M9.86572 2.19995H17C18.1046 2.19995 19 3.09538 19 4.19995V7.36918H9.86572V2.19995Z"></path>
      <rect ${pathS(null,'auto')} ${rectS(9.13,5.75,9.87,7.37)} x="9.86572" y="7.36914" width="9.13428" height="5.7478"></rect>
      <path ${pathS(null,'auto')} d="M9.86572 13.1169H19V17.0002C19 18.1048 18.1046 19.0002 17 19.0002H9.86572V13.1169Z"></path>
    </svg>
      `;
  }
};
...
class inputnamerule extends HTMLElement {
  constructor() {
    ...
    ${icon(20)}
      ...
      <rect ${pathS('auto')} ${rectS(8.5,2,0,4,1)}></rect>
      <rect ${pathS('auto')} ${rectS(20,2,0,16,1)}></rect>
      <rect ${pathS('auto')} ${rectS(2,18,2,2,1)}></rect>
      <rect ${pathS('auto')} ${rectS(2,16,16,4,1)}></rect>
      <path ${pathS('auto')} d="M6.97137 16.0954C6.62768 16.3986 6.09115 16.1182 6.14391 15.6629L6.71709 10.717L10.7051 12.8016L6.97137 16.0954Z"></path>
      <path ${pathS('auto')} d="M11.3154 11.5259L7.35709 9.45685L11.5784 1.38079C11.8343 0.891339 12.4385 0.701954 12.9279 0.957792L15.1138 2.10035C15.6032 2.35618 15.7926 2.96036 15.5368 3.44982L11.3154 11.5259Z"></path>
    </svg>
      `;
  }
};
...
class tabtablestyle extends HTMLElement {
  constructor() {
    ...
    this.innerHTML = `
    ${icon(20)}
      <path ${pathS('auto')} fill-rule="evenodd" clip-rule="evenodd" d="M16 2.57129C17.1045 2.57129 17.9998 3.46686 18 4.57129V16.5713L17.9893 16.7754C17.887 17.7841 17.0357 18.5713 16 18.5713H4C2.96435 18.5713 2.113 17.7841 2.01074 16.7754L2 16.5713V4.57129C2.00016 3.46686 2.89553 2.57129 4 2.57129H16ZM3 16.5713C3 17.1236 3.44772 17.5713 4 17.5713H9.5V13.0713H3V16.5713ZM10.5 17.5713H16C16.5523 17.5713 17 17.1236 17 16.5713V13.0713H10.5V17.5713ZM3 12.0713H9.5V7.57129H3V12.0713ZM10.5 12.0713H17V7.57129H10.5V12.0713Z"/>
    </svg>
      `;
      /*
      ...
      <path ${pathS('auto')} d="M11.8598 12.0372L8.12642 15.3311C7.78273 15.6343 7.24651 15.3537 7.29927 14.8985L7.87154 9.95317L11.8598 12.0372ZM12.7329 0.616255C12.9887 0.127036 13.5931 -0.0621097 14.0825 0.193403L16.269 1.33598C16.7583 1.59183 16.9475 2.19621 16.6919 2.68559L12.4702 10.7618L8.51216 8.69243L12.7329 0.616255Z"></path>
      */
  }
};
customElements.define('tab-tablestyle', tabtablestyle);

class tabletheme extends HTMLElement {
  constructor() {
    super();
    this.className = 'df-cc wh100';
    this.innerHTML = `
    ${icon(20)}
      <path ${pathS('auto')} d="M9.30859 7.57129H3V12.0713H6.38574C6.34388 12.3761 6.32558 12.7082 6.33105 13.0713H3V16.5713C3 17.1236 3.44772 17.5713 4 17.5713H9.5V16.6553C9.8522 16.6228 10.1857 16.5689 10.5 16.4834V17.5713H16C16.5523 17.5713 17 17.1236 17 16.5713V13.0713H13.1348C13.1492 12.8588 13.154 12.6483 13.1533 12.4482C13.1529 12.3212 13.1474 12.195 13.1426 12.0713H17V7.57129H14.7852L17.1387 3.65234L17.2422 3.45605C17.2942 3.34318 17.3328 3.22717 17.3623 3.11035C17.7537 3.47537 17.9999 3.99393 18 4.57129V16.5713L17.9893 16.7754C17.887 17.7841 17.0357 18.5713 16 18.5713H4C2.96435 18.5713 2.113 17.7841 2.01074 16.7754L2 16.5713V4.57129C2.00016 3.46686 2.89553 2.57129 4 2.57129H10.9854L9.30859 7.57129Z"/>
      <path ${pathS('auto')} d="M12.0118 10.8567C12.1158 11.3021 12.3584 13.4964 11.7893 14.3662C11.0779 15.4534 10.1746 15.7011 8.36322 15.7011L6.29321 15.7014C6.29321 15.7014 7.41851 14.6825 7.34502 13.4419C7.17913 10.6403 8.36383 10.6551 9.47346 9.90359L12.0118 10.8567Z"/>
      <path ${pathS('auto')} d="M12.4565 1.52011C12.8449 0.396249 14.1143 -0.152193 15.1988 0.335343C16.2961 0.82873 16.723 2.16492 16.1152 3.20316L11.9638 10.2941L9.77742 9.27123L12.4565 1.52011Z"/>
    </svg>
    `;
  }
};
customElements.define('tab-tabletheme', tabletheme);
...
class btnrelayout extends HTMLElement {
  constructor() {
    ...
    ${icon(21)}
      ...
      <rect ${rectS(3,3,9,3)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,15,3)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,3,9)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,9,9)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,15,9)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,3,15)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,9,15)} ${pathS('auto')}></rect>
      <rect ${rectS(3,3,15,15)} ${pathS('auto')}></rect>
    </svg>
      `;
  }
};
...
class inputregexpenter extends HTMLElement {
  constructor() {
    ...
    ${svgS('0 0 20 23','100%','100%')}
      ...
      <rect ${rectS(16,16,2,2,2)} ${pathS(null,'auto')}></rect>
      <rect ${rectS(16,2,2,21,1)} ${pathS('auto')}></rect>
    </svg>
  `;
  }
};
...
class btnmore extends HTMLElement {
  constructor() {
    ...
    ${icon(22)}
          <g data-path="1" >
            <rect ${rectS(20,0.5,1,0,1)} ${pathS('auto')}></rect>
          </g>
          <g data-path="2">
            <rect ${rectS(20,0.5,1,0,1)} ${pathS('auto')}></rect>
          </g>
...
class mapname extends HTMLElement {
  constructor() {
    super();
    this.className = 'df-cc wh100';
    this.innerHTML = `
    ${icon(20)}
      <path ${pathS('auto')} d="M17.845 13.8459C19.0247 14.1732 19.0562 15.8348 17.8899 16.2063L10.4583 18.5667C10.2187 18.6426 9.96099 18.6429 9.72095 18.5686L2.11938 16.2092C0.941888 15.8436 0.973102 14.1661 2.16333 13.844L2.86841 13.6536L5.14966 14.3606L2.65747 15.0354L10.0852 17.3411L17.3469 15.0354L14.9124 14.3616L17.1458 13.6526L17.845 13.8459ZM17.845 10.4397C19.0252 10.7667 19.0565 12.4286 17.8899 12.8L10.4583 15.1604C10.2186 15.2364 9.96111 15.2368 9.72095 15.1624L2.11938 12.803C0.941861 12.4373 0.973076 10.7598 2.16333 10.4377L2.28638 10.4036L4.56763 11.1116L2.65747 11.6292L10.0852 13.9348L17.3469 11.6292L15.4807 11.1125L17.7141 10.4026L17.845 10.4397Z"/>
      <path ${pathS('auto')} d="M16.4775 1.91504C17.5821 1.91504 18.4785 2.81047 18.4785 3.91504V8.40234C18.4785 9.50691 17.5821 10.4023 16.4775 10.4023H3.52344C2.41887 10.4023 1.52246 9.50691 1.52246 8.40234V3.91504C1.52246 2.81047 2.41887 1.91504 3.52344 1.91504H16.4775ZM6.96973 4.25781C6.74198 4.03007 6.37244 4.03032 6.14453 4.25781L5.06934 5.33203L3.99512 4.25781C3.76737 4.03007 3.39783 4.03032 3.16992 4.25781C2.9422 4.4857 2.9421 4.85518 3.16992 5.08301L4.24414 6.15723L3.16992 7.23242C2.94216 7.4603 2.94209 7.82978 3.16992 8.05762C3.39777 8.28535 3.76727 8.28534 3.99512 8.05762L5.06934 6.98242L6.14453 8.05762C6.37237 8.28526 6.7419 8.28528 6.96973 8.05762C7.19716 7.82977 7.19729 7.46018 6.96973 7.23242L5.89453 6.15723L6.96973 5.08301C7.19718 4.85514 7.19737 4.48557 6.96973 4.25781ZM11.9922 4.25781C11.7643 4.03035 11.3947 4.03008 11.167 4.25781L10.0918 5.33203L9.01758 4.25781C8.78967 4.03031 8.42013 4.03006 8.19238 4.25781C7.96474 4.48557 7.96492 4.85514 8.19238 5.08301L9.2666 6.15723L8.19238 7.23242C7.96472 7.46017 7.96495 7.82973 8.19238 8.05762C8.42023 8.28547 8.7897 8.28542 9.01758 8.05762L10.0918 6.98242L11.167 8.05762C11.3948 8.28546 11.7643 8.28538 11.9922 8.05762C12.2201 7.82974 12.2201 7.4603 11.9922 7.23242L10.917 6.15723L11.9922 5.08301C12.2201 4.85513 12.2201 4.48569 11.9922 4.25781ZM17.0156 4.25781C16.7877 4.03039 16.4182 4.03009 16.1904 4.25781L15.1152 5.33203L14.041 4.25781C13.8131 4.03039 13.4435 4.03009 13.2158 4.25781C12.9882 4.48554 12.9884 4.85513 13.2158 5.08301L14.29 6.15723L13.2158 7.23242C12.9882 7.46016 12.9885 7.82976 13.2158 8.05762C13.4437 8.28523 13.8132 8.28527 14.041 8.05762L15.1152 6.98242L16.1904 8.05762C16.4183 8.28525 16.7878 8.28532 17.0156 8.05762C17.2434 7.82981 17.2433 7.46031 17.0156 7.23242L15.9404 6.15723L17.0156 5.08301C17.2434 4.8552 17.2433 4.4857 17.0156 4.25781Z"/>
    </svg>
    `;
  }
};
customElements.define('map-name', mapname);

class maptext extends HTMLElement {
  constructor() {
    super();
    this.className = 'df-cc wh100';
    this.innerHTML = `
    ${icon(20)}
      <path ${pathS('auto')} d="M10.7383 1.99268L10.7382 6.24974H9.30963L9.26553 5.76973C9.21826 5.25505 8.78657 4.8612 8.26973 4.8612H7.44465L7.43139 9.96049C7.43012 10.4498 7.78316 10.8682 8.26574 10.9493L8.81521 11.0416V12.9274H3.71752V11.0416L4.43067 10.9354C4.9197 10.8626 5.28211 10.4433 5.2834 9.94889L5.29663 4.8612H4.36025C3.84108 4.8612 3.40826 5.25851 3.36391 5.77578L3.32327 6.24974H1.88623L1.88635 1.99268H10.7383Z"/>
      <path ${pathS('auto')} d="M16 2C17.1046 2 18 2.89543 18 4V16C18 17.1046 17.1046 18 16 18H4C2.89543 18 2 17.1046 2 16V13.6777H3.28027V16C3.28027 16.3976 3.60235 16.7197 4 16.7197H16C16.3976 16.7197 16.7197 16.3976 16.7197 16V4C16.7197 3.60235 16.3976 3.28027 16 3.28027H11.5566V2H16Z"/>
      <path ${pathS(null,'auto',1.28,'round','round')} d="M5 14.9431H15"/>
      <path ${pathS(null,'auto',1.28,'round','round') } d="M12.0312 12.2346L15 12.2348"/>
      <path ${pathS(null,'auto',1.28,'round','round') } d="M12.0312 9.52612H15"/>
      <path ${pathS(null,'auto',1.28,'round','round') } d="M12.0312 6.81763H15"/>
    </svg>
    `;
  }
};
customElements.define('map-text', maptext);

class mappro extends HTMLElement {
  constructor() {
    super();
    this.className = 'df-cc wh100';
    this.innerHTML = `
    ${icon(20)}
    <path ${pathS('auto')} d="M11.6545 2.02881C11.1952 2.37514 10.8073 2.81041 10.5139 3.30811H5.33032C4.10376 3.30827 3.10962 4.30221 3.10962 5.52881C3.10984 6.75522 4.1039 7.74935 5.33032 7.74951H10.5139C10.8075 8.24733 11.1959 8.68252 11.6555 9.02881H5.33032C3.3976 9.02864 1.83054 7.46151 1.83032 5.52881C1.83032 3.59591 3.39747 2.02897 5.33032 2.02881H11.6545Z"/>
    <circle ${pathS('auto')} ${circleS(14.2891,5.5284,3.88045)}/>
    <path ${pathS('auto')} d="M15.0286 10.5845C16.8779 10.6782 18.3489 12.207 18.3489 14.0796L18.344 14.2593C18.2534 16.0491 16.8183 17.484 15.0286 17.5747L14.8489 17.5796H5.33032C3.39738 17.5796 1.83041 16.0125 1.83032 14.0796C1.83032 12.1466 3.39733 10.5796 5.33032 10.5796H14.8489L15.0286 10.5845ZM5.33032 11.8589C4.10362 11.8589 3.10962 12.8529 3.10962 14.0796C3.10971 15.3062 4.10367 16.3003 5.33032 16.3003H14.8489C16.0754 16.3001 17.0695 15.3061 17.0696 14.0796C17.0696 12.853 16.0754 11.8591 14.8489 11.8589H5.33032Z"/>
    <path ${pathS(null,'auto',1,'round','round')} d="M12.5291 13.4641L13.9477 15.0053L15.3413 13.4641"/>
    </svg>
    `;
  }
};
customElements.define('map-pro', mappro);

class maptag extends HTMLElement {
  constructor() {
    super();
    this.className = 'df-cc wh100';
    this.innerHTML = `
    ${icon(20)}
    <path ${pathS(null,'auto',1.28)} fill-rule="evenodd" clip-rule="evenodd" d="M14.2148 2.06007C15.1896 2.17976 15.8834 3.06675 15.7637 4.04152L15.6533 4.94386H16.2227C17.2046 4.94408 18 5.74023 18 6.72218C17.9998 7.70393 17.2044 8.49931 16.2227 8.49953H15.2158L14.8477 11.4995H16.2227C17.2044 11.4997 17.9998 12.296 18 13.2778C18 14.2598 17.2046 15.056 16.2227 15.0562H14.4111L14.2471 16.3921C14.1274 17.3668 13.2403 18.0595 12.2656 17.94C11.2909 17.8203 10.5971 16.9333 10.7168 15.9585L10.8271 15.0562H7.93164L7.76758 16.3921C7.64789 17.3669 6.75993 18.0596 5.78516 17.94C4.81058 17.8201 4.11763 16.9332 4.2373 15.9585L4.34766 15.0562H3.77832C2.79641 15.056 2 14.2598 2 13.2778C2.00018 12.296 2.79653 11.4997 3.77832 11.4995H4.78516L5.15332 8.49953H3.77832C2.79657 8.49931 2.00025 7.70393 2 6.72218C2 5.74023 2.79641 4.94408 3.77832 4.94386H5.58984L5.75391 3.60793C5.87359 2.63316 6.76058 1.94039 7.73535 2.06007C8.71011 2.17977 9.40289 3.06675 9.2832 4.04152L9.17285 4.94386H12.0693L12.2334 3.60793C12.3531 2.63327 13.2402 1.9406 14.2148 2.06007Z"/>
    <path ${pathS(null,'auto',1.28)} fill-rule="evenodd" clip-rule="evenodd" d="M8.73633 8.49951L8.36816 11.4995H11.2646L11.6328 8.49951H8.73633Z"/>
    </svg>
    `;
  }
};
